...
def create_substrabackend_config(org, orderer_conf):

    dir_path = f"{SUBSTRA_PATH}/conf/{org['name']}/substrabackend"
    ...
    filename = f"{SUBSTRA_PATH}/conf/{org['name']}/substrabackend/conf.json"
