...
def register_random_algo():
    ...
    args = {
        'name': str(u),
        'hash': hash,
        'storageAddress': f'http://substra-backend.owkin.xyz:8001/algo/{hash}/file/',
        'descriptionHash': descriptionHash,
        'descriptionStorageAddress': f'http://substra-backend.owkin.xyz:8001/algo/{hash}/description/',
        'permissions': 'all'
    }
